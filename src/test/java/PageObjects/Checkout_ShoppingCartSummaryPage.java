...
public class Checkout_ShoppingCartSummaryPage extends FuncBase{
	
	private static WebElement ele = null;
	
	
	private static String DeleteIcon_cs = "table#cart_summary a > i";
	private static String Proceed2ChkOutBtn_cs = "div#center_column a.button.btn.btn-default.standard-checkout.button-medium > span";
